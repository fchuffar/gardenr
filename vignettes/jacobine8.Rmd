...
subtitle: "Schéma d'implantation de la cloture et des portillons"
...
source("jaco_bg.R")
# frame
parc(-14,  1.5,  8, 5, col="lightgreen" , leg=c("P1", "Jean-François"       ))
...
parc(7.5,  17.5,  7, 8, col="lightgreen", leg=c("P7", "Florent"  ))
